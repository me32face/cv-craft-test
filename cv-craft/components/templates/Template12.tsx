...
<div id="resume-root" className="bg-white rounded shadow overflow-hidden">
  <div className="h-36 bg-gradient-to-r from-slate-800 to-white flex items-center p-6">
    <div className="flex items-center gap-4">
      <div className="w-28 h-28 rounded-full overflow-hidden border"><div className="w-full h-full"><ImageUploader keyName="photo12" initial="/profile-placeholder.png" className="w-full h-full" /></div></div>
    ...
    <aside className="bg-gray-50 p-3 rounded">
      ...
      <div className="mt-2 text-sm" contentEditable suppressContentEditableWarning>hello@reallygreatsite.com</div>
        ...
        <div className='mt-4 flex justify-end gap-2 print:hidden'>
          <PrintToPdf rootId='resume-root' fileName='Template12.pdf' />
        </div>
      </div>
    </div>
  )
