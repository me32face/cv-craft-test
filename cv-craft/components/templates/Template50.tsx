  ...
  <div className="grid md:grid-cols-3 gap-4">
    <div className="md:col-span-2">
      <div className="flex gap-4 items-center">
        <div className="w-28 h-28 rounded-full overflow-hidden border"><div className="w-full h-full"><ImageUploader keyName="photo50" initial="/profile-placeholder.png" className="w-full h-full" /></div></div>
        <div>
    ...
    <aside className="p-3 border-l">
      ...
      <ul className="mt-2 text-sm" contentEditable suppressContentEditableWarning>
        ...
        <div className='mt-4 flex justify-end gap-2 print:hidden'>
          <PrintToPdf rootId='resume-root' fileName='Template50.pdf' />
        </div>
      </div>
    </div>
  )
