...
<div id="resume-root" className="bg-white rounded shadow overflow-hidden">
  <div className="h-36 bg-gradient-to-r from-amber-700 to-white flex items-center p-6">
    <div className="flex items-center gap-4">
      <div className="w-28 h-28 rounded-full overflow-hidden border"><div className="w-full h-full"><ImageUploader keyName="photo48" initial="/profile-placeholder.png" className="w-full h-full" /></div></div>
  ...
  <div className="p-6 grid md:grid-cols-3 gap-4">
    <div className="md:col-span-2">
      <h4 className="font-semibold text-amber-700">Summary</h4>
