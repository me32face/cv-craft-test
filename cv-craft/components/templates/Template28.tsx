...
<div id="resume-root" className="bg-white rounded p-6 shadow">
  <div className="flex gap-4 items-center">
    <div className="w-28 h-28 rounded-full overflow-hidden border"><div className="w-full h-full"><ImageUploader keyName="photo28" initial="/profile-placeholder.png" className="w-full h-full" /></div></div>
  ...
  <div className="mt-4 grid md:grid-cols-2 gap-4 font-serif">
    <div>
      ...
      <h4 className="mt-4 font-semibold text-slate-800">Experience</h4>
    ...
    <aside className="bg-gray-50 p-3 rounded">
      ...
      <h4 className="mt-4 font-semibold text-slate-800">Education</h4>
      <div contentEditable suppressContentEditableWarning className="text-sm mt-2">Master — North State University (2025–2027)</div>
        ...
        <div className='mt-4 flex justify-end gap-2 print:hidden'>
          <PrintToPdf rootId='resume-root' fileName='Template28.pdf' />
        </div>
      </div>
    </div>
  )
