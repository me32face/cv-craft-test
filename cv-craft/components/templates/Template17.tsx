...
<div id="resume-root" className="bg-gradient-to-r from-indigo-700/10 to-white rounded p-6 shadow font-mono">
  <div className="flex items-center gap-4">
    <div className="w-full h-28 overflow-hidden rounded-md border"><ImageUploader keyName="photo17" initial="/profile-placeholder.png" className="w-full h-full" /></div>
    <div>
    ...
    <aside contentEditable suppressContentEditableWarning className="bg-white p-3 rounded">
      ...
      hello@reallygreatsite.com
        ...
        <div className='mt-4 flex justify-end gap-2 print:hidden'>
          <PrintToPdf rootId='resume-root' fileName='Template17.pdf' />
        </div>
      </div>
    </div>
  )
