...
<div id="resume-root" className="bg-[rgb(247,239,230)] rounded p-6 shadow font-sans">
  <div className="flex gap-4 items-center">
    <div className="w-28 h-28 rounded-full overflow-hidden border"><div className="w-full h-full"><ImageUploader keyName="photo18" initial="/profile-placeholder.png" className="w-full h-full" /></div></div>
    <div>
    ...
    <aside>
      ...
      Master — North State University (2025–2027)
        ...
        <div className='mt-4 flex justify-end gap-2 print:hidden'>
          <PrintToPdf rootId='resume-root' fileName='Template18.pdf' />
        </div>
      </div>
    </div>
  )
