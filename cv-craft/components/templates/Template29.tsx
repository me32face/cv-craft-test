...
<div id="resume-root" className="md:flex bg-white rounded overflow-hidden shadow">
  <aside className="md:w-1/3 p-6 bg-gradient-to-b from-emerald-700/10">
    <div className="w-28 h-28 rounded-full overflow-hidden border"><div className="w-full h-full"><ImageUploader keyName="photo29" initial="/profile-placeholder.png" className="w-full h-full" /></div></div>
  ...
  <main className="p-6 md:flex-1 font-mono">
    <h4 className="font-semibold text-emerald-700">Professional Summary</h4>
