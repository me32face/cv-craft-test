...
export default function Home() {
  ...
  const templates = [
    ...
    { id: 'Template09', name: 'Richard Whait', key: 'Olivia Wilson', image: '/template/template09.png', category: 'modern' },
  ...
  if (selectedTemplate) {
    return <CVBuilder initialTemplate={selectedTemplate} onBack={() => setSelectedTemplate(null)} />;
  }
