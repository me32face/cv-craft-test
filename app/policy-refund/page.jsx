      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <header className="mb-12  pb-8">
          ...
          <div className="mt-6 p-4 ">
            <p className="text-gray-700 mb-12"><strong>Company Name:</strong> Esta Enterprises Pvt. Ltd.</p>
            <p className="text-gray-700 mt-2"> At <strong>Esta Enterprises Pvt. Ltd.</strong>, we take pride in delivering high-quality IT solutions, software products, mobile applications, and web development services. Our goal  is to ensure complete satisfaction for our clients while maintaining transparency and fairness   in all transactions. </p>
          </div>
        </header>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700"> All payments made to Esta Enterprises Pvt. Ltd. are for services agreed upon in the project  related to software development, website design, digital applications, or related IT solutions.  Since these services involve dedicated effort, time, and resources, refunds are subject to  specific terms and conditions outlined below.</p>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-4 text-gray-700">
            <li> <strong>Service not delivered:</strong> If Esta Enterprises Pvt. Ltd. fails to deliver the agreed services within the timeframe outlined in the contract.</li>
            ...
            <li><strong>Non-delivery of service:</strong> If Esta Enterprises Pvt. Ltd. is unable to deliver the agreed service within the stipulated timeframe due to internal constraints. </li></ul>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700"> However, Esta Enterprises Pvt. Ltd. may, at its discretion, consider partial refunds for unutilized work stages if mutually agreed in writing.</p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 mb-4"> Clients must submit a refund request in writing to{' '}
            <a href="mailto:refund@estenterprises.in" className="text-red-600 underline"> refund@estenterprises.in</a>{' '}  with:</p>
          <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700">Esta Enterprises Pvt. Ltd. reserves the right to update or modify this Refund Policy at any time. The latest version will always be available on our official website. Continued use of our services after such changes constitutes acceptance of the revised policy.</p>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-2 text-gray-700">
            <p><strong>📧 </strong>{' '}<a href="mailto:privacy@estenterprises.in" className="text-red-600 hover:underline"> privacy@estenterprises.in </a></p>
            <p><strong>🌐</strong>{' '}<a href="https://www.estenterprises.com" target="_blank" rel="noopener noreferrer" className="text-red-600 hover:underline">www.estenterprises.com </a> </p>
