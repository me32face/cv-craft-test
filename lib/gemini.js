...
class GeminiService {
  constructor() {
    ...
    const apiKey = process.env.NEXT_PUBLIC_GEMINI_API_KEY || 'AIzaSyDDq7JmXtonHsSgx5nbqOam2Cq-J3evoR8';
    if (apiKey) {
  ...
  async generateContent(section, keywords) {
    ...
    if (!this.model) {
      try {
        ...
        const models = ["gemini-2.5-pro", "gemini-1.5-flash", "gemini-pro", "gemini-1.0-pro"];
