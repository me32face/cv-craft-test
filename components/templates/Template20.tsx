...
<div id="resume-root" className="md:flex bg-white rounded overflow-hidden shadow">
  <aside className="md:w-1/3 p-6 bg-gradient-to-b from-slate-800/10">
    <div className="w-28 h-28 rounded-full overflow-hidden border"><div className="w-full h-full"><ImageUploader keyName="photo20" initial="/profile-placeholder.png" className="w-full h-full" /></div></div>
    ...
    <div className="mt-4">
      ...
      <div contentEditable suppressContentEditableWarning className="mt-2">Senior Systems Engineer — The IT Company</div>
        ...
        <div className='mt-4 flex justify-end gap-2 print:hidden'>
          <PrintToPdf rootId='resume-root' fileName='Template20.pdf' />
        </div>
      </div>
    </div>
  )
