...
const initialResumeData = {
  ...
  workExperience: [
...

    {
      ...
      details: [
        "Assisting in the development and implementation of digital marketing strategies.",
        ...
        "Analyzing campaign performance and preparing reports.",
      ],
    },
  ],
...
export default function Template17() {
      ...
      switch (section.toLowerCase()) {
        ...
        case "about":
          const aboutElement = document.querySelector(
            '[data-section="about"] [contenteditable]'
          );
          if (aboutElement) {
            ...
            const actualAbout = paragraphs.find(
              (p) =>
            ...
            const finalContent =
              actualAbout?.trim() || paragraphs[0]?.trim() || cleanedContent;
  ...
  const CVPage = () => (
    <div className="w-[210mm] h-[297mm] bg-white shadow-2xl flex overflow-hidden relative">
      ...
      <aside
        className="w-[35%] bg-black text-white flex flex-col items-center py-6 px-8 leading-relaxed"
      ...
      >
        ...
        <section className="w-full mb-6 section-item" data-section="contact">
          <h2
            className="font-bold text-xl border-b border-white pb-1 mb-4 tracking-wide"
            contentEditable
          ...
          <div className="space-y-3">
            {contentState.contact.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group flex items-center gap-2 relative section-item"
                >
                  {Icon && <Icon size={16} />}
                  <span
                    contentEditable
                  ...
                  <div className="flex gap-1 absolute right-0 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                      ...
                      className="text-gray-400 rounded p-1"
                    >
                      <CopyPlus size={14} />
                    </button>
                    <button
        ...
        <section className="w-full mb-6 section-item" data-section="skills">
          ...
          <ul
            ...
            onBlur={handleListCleanup}
          >
            {contentState.skills.map((skill, i) => (
              <li
                key={i}
                className="group flex items-center justify-between gap-2 relative section-item"
              >
      ...
      <section
        className="flex-1 bg-white p-8 leading-relaxed text-gray-900"
        onClick={handleButtonClick}
      >
        {/* Name and Title */}
        ...
        <section className="mb-6 section-item" data-section="about">
          <div className="relative group">
            <h2
              className="font-bold text-xl border-b-2 border-black mb-4 tracking-wide"
              contentEditable
              suppressContentEditableWarning
            >
              ABOUT ME
        ...
        <section className="mb-6" data-section="work">
          ...
          <div className="flex flex-col gap-6 relative">
            {contentState.workExperience.map((job, i) => (
              <div
                key={job.id}
                className="relative pl-6 section-item"
                data-id={job.id}
              >
                ...
                <div className="flex justify-between items-start mb-1 group relative">
                  ...
                  <div className="flex gap-2 ml-3 absolute right-0 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                      data-action="duplicate"
                      className="text-gray-600 rounded p-1"
                    >
                      <CopyPlus size={16} />
                    </button>
                    <button
