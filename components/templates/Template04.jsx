  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 overflow-auto">
      ...
      >
        ...
        <div className="w-[35%] bg-slate-700 text-white p-8">
          {/* Profile Image */}
          <div className="mb-8">
            <div
          ...
          {/* Expertise Section */}
          <div className="mb-8" data-section="expertise">
            <div className="flex items-center gap-2 mb-4">
              <h2 className="text-xl font-bold pb-2 border-b border-gray-500">Expertise</h2>
              <AISparkle className='-mt-1 ml-1' section="Skills" onGenerate={handleAIGenerate} />
            </div>
        ...
        <div className="w-[65%] bg-white p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600 mb-4" contentEditable suppressContentEditableWarning>
              ...
              <AISparkle className=' mb-3' section="Summary" onGenerate={handleAIGenerate} />
