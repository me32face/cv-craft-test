...
export default function Template49() {
  return (
...
<div id="resume-root" className="bg-white rounded p-6 shadow font-serif">
  <div className="flex items-center gap-4">
    <div className="w-28 h-28 rounded-full overflow-hidden border"><div className="w-full h-full"><ImageUploader keyName="photo49" initial="/profile-placeholder.png" className="w-full h-full" /></div></div>
  ...
  <div className="mt-6">
    <h4 className="font-semibold text-indigo-700">Experience Timeline</h4>
    <div className="mt-4 space-y-4">
      <div className="flex gap-3 items-start">
        <div className="w-2 h-2 bg-indigo-700 rounded mt-2"></div>
      ...
      <div className="flex gap-3 items-start">
        ...
        <div className='mt-4 flex justify-end gap-2 print:hidden'>
          <PrintToPdf rootId='resume-root' fileName='Template49.pdf' />
        </div>
      </div>
    </div>
  )
