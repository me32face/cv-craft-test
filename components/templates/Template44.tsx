...
export default function Template44() {
  return (
    <div className='min-h-screen p-6 bg-gray-50 flex items-start justify-center'>
      <div className='w-full max-w-4xl'>
<div id="resume-root" className="bg-gradient-to-r from-slate-800/10 to-white rounded p-6 shadow font-mono">
  <div className="flex items-center gap-4">
    <div className="w-full h-28 overflow-hidden rounded-md border"><ImageUploader keyName="photo44" initial="/profile-placeholder.png" className="w-full h-full" /></div>
    <div>
    ...
    <aside contentEditable suppressContentEditableWarning className="bg-white p-3 rounded">
      ...
      hello@reallygreatsite.com
        ...
        <div className='mt-4 flex justify-end gap-2 print:hidden'>
          <PrintToPdf rootId='resume-root' fileName='Template44.pdf' />
        </div>
      </div>
    </div>
  )
