...
import { Phone, Mail, MapPin, Globe, Briefcase, GraduationCap, Download } from 'lucide-react';
...
export default function Template01() {
  ...
  return (
    ...
    <>
      <Header />
      <div className="flex-1 bg-gray-100 flex flex-col justify-center items-center overflow-auto p-4">
        <button
          onClick={downloadPDF}
