...
export default function Template33() {
  return (
...
<div id="resume-root" className="bg-white rounded p-4 shadow font-sans">
  <div className="flex items-center gap-3">
    <div className="w-16 h-16 rounded-full overflow-hidden border">
      <ImageUploader keyName="photo33" initial="/profile-placeholder.png" className="w-full h-full" />
    </div>
    <div>
  ...
  <div className="mt-3" contentEditable suppressContentEditableWarning>
    Experience: Senior Systems Engineer — The IT Company
        ...
        <div className='mt-4 flex justify-end gap-2 print:hidden'>
          <PrintToPdf rootId='resume-root' fileName='Template33.pdf' />
        </div>
      </div>
    </div>
  )
