...
<div id="resume-root" className="bg-white rounded shadow overflow-hidden">
  <div className="h-36 bg-gradient-to-r from-emerald-700 to-white flex items-center p-6">
    <div className="flex items-center gap-4">
      <div className="w-28 h-28 rounded-full overflow-hidden border"><div className="w-full h-full"><ImageUploader keyName="photo21" initial="/profile-placeholder.png" className="w-full h-full" /></div></div>
