...
export default function Template45({ data = {}, onClickSection }) {
  ...
  return (
    ...
    >
      ...
      <div className="cv-sidebar w-1/3 relative z-10 flex flex-col pt-12 pb-10 bg-[#e9efed] ">
        ...
        >
          <img src={data?.profileImage || "/templateprofile/template38profile.jpeg"} className="w-full h-full object-cover" alt="profile" />
        </div>
          </div>
        </div>
        {/* Sidebar Content */}
  ...
  <div className="flex items-center gap-1 leading-[1.4]">
              ...
              <div className="flex items-center gap-1 leading-[1.4]">
                <span className="font-medium">Marital Status:</span>  <span>{data?.maritalStatus}</span>
              </div>
              )}
